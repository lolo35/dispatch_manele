...
<template>
    <div class="flex flex-col bg-gray-100 shadow border px-3 py-2 rounded dark:bg-gray-800 dark:border-gray-700 relative">
        ...
        <div class="absolute left-0 right-0 top-12" v-if="showOptions">
            <div 
                ...
                <div class="flex flex-row px-2 py-1 dark:hover:bg-sky-500 cursor-pointer" v-for="dispatchtype in filtered" :key="dispatchtype.id">
